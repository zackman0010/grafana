...
export const toolSetCanSpeak = new DynamicTool({
  name: 'set_can_speak',
  description:
    "Set whether the agent can speak (write to localStorage). Only adjust the voice setting on the user's request. By default the voice will be `Google UK English Female`.",
