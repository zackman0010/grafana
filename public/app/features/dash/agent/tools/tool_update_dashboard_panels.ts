...
export const updateDashboardPanelsTool = tool(
  ...
  },
  {
    ...
    description:
      'Updates multiple dashboard panels with new configurations. Get the configurations via read_dashboard_panels tool first. Automatically navigate the user to view the dashboard before making any changes.',
