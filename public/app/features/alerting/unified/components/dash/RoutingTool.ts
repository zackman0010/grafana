...
const createAlertSchema = z.object({
  navigate: z.boolean().describe('Whether to navigate to create a new alert. Only ever set this to true if the user has confirmed to create a new alert.'),
  returnTo: z.string().optional().describe('Optional URL to return to after creating the alert.'),
  defaults: defaultsSchema.optional().describe('Optional default values for the new alert, including type, queries, name, condition, and annotations.'),
});
