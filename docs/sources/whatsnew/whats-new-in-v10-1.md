...
- Angular Plugins will not be loaded if [angular\_support\_enabled](../../setup-grafana/configure-grafana/#angular_support_enabled) is set to `false`.
