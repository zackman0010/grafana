...
{{\< figure src="/media/docs/grafana/transformations/transformations\_ui\_drawer\_selector.png" caption="The new Transformation UI drawer" alt="Transformation UI drawer" \>}}
