...
{{\< figure src="/static/img/docs/time-range-controls/fiscal\_year-8-2.png" max-width="1200px" caption="Fiscal Year Time Range Settings" \>}}
...
{{\< figure src="/static/img/docs/enterprise/8\_2\_stats\_licensing\_screen.png" max-width="1200px" caption="Stats and licensing" \>}}
...
{{\< figure src="/static/img/docs/enterprise/8\_2\_data\_source\_permissions.png" max-width="1200px" caption="Stats and licensing" \>}}
...
{{\< figure src="/static/img/docs/enterprise/8\_2\_export\_usage\_insights.png" max-width="1200px" caption="Stats and licensing" \>}}
