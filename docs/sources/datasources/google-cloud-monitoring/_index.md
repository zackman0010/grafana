...
{{\< figure src="/static/img/docs/v71/cloudmonitoring\_service\_account\_choose\_role.png" max-width="600px" class="docs-image--no-shadow" caption="Choose role" \>}}
...
2. On each page, click the `Enable` button.
   ...
   {{\< figure src="/static/img/docs/v71/cloudmonitoring\_enable\_api.png" max-width="450px" class="docs-image--no-shadow" caption="Enable GCP APIs" \>}}
