...
- ../meta-monitoring/ \# /docs/grafana/\<GRAFANA\_VERSION\>/alerting/meta-monitoring/
- ../monitoring/ \# /docs/grafana/\<GRAFANA\_VERSION\>/alerting/monitoring/
- ../monitor/ \# /docs/grafana/\<GRAFANA\_VERSION\>/alerting/monitor/
