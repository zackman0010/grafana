...
## \_build: list: false labels: products: - cloud - enterprise - oss title: Release notes for Grafana 8.0.4
...
- **Elasticsearch:** Allow case sensitive custom options in date\_histogram interval. [\#36168](https://github.com/grafana/grafana/pull/36168), [@Elfo404](https://github.com/Elfo404)
