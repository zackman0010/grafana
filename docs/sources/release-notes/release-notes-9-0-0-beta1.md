...
## hide\_menu: true labels: products: - cloud - enterprise - oss title: Release notes for Grafana 9.0.0-beta1
...
- **SAML:** Implement Name Templates for assertion\_attribute\_name option. (Enterprise)
