...
## \_build: list: false labels: products: - cloud - enterprise - oss title: Release notes for Grafana 8.3.3
...
- **Loki:** Fix adding of ad hoc filters for queries with parser and line\_format expressions. [\#42590](https://github.com/grafana/grafana/pull/42590), [@ivanahuckova](https://github.com/ivanahuckova)
