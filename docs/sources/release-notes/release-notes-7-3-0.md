...
## \_build: list: false labels: products: - cloud - enterprise - oss title: Release notes for Grafana 7.3.0
...
- **Database**: Adds new indices to alert\_notification\_state and alert\_rule\_tag tables. [\#28166](https://github.com/grafana/grafana/pull/28166), [@KarineValenca](https://github.com/KarineValenca)
