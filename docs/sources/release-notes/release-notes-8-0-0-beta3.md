...
## \_build: list: false labels: products: - cloud - enterprise - oss title: Release notes for Grafana 8.0.0-beta3
...
- **OAuth:** Fix fallback to auto\_assign\_org\_role setting for Azure AD OAuth when no role claims exists. [\#34838](https://github.com/grafana/grafana/pull/34838), [@idafurjes](https://github.com/idafurjes)
