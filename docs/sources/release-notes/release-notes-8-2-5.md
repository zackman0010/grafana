...
## \_build: list: false labels: products: - cloud - enterprise - oss title: Release notes for Grafana 8.2.5
...
- **Elasticsearch:** Use field configured in query editor as field for date\_histogram aggregations. [\#41258](https://github.com/grafana/grafana/pull/41258), [@Elfo404](https://github.com/Elfo404)
