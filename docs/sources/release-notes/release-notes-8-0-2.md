...
## \_build: list: false labels: products: - cloud - enterprise - oss title: Release notes for Grafana 8.0.2
...
- **Datasource:** Add support for max\_conns\_per\_host in dataproxy settings. [\#35520](https://github.com/grafana/grafana/pull/35520), [@jvrplmlmn](https://github.com/jvrplmlmn)
