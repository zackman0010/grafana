...
## \_build: list: false labels: products: - cloud - enterprise - oss title: Release notes for Grafana 7.4.0
...
- **Annotations**: Remove annotation\_tag entries as part of annotations cleanup. [\#29534](https://github.com/grafana/grafana/pull/29534), [@dafydd-t](https://github.com/dafydd-t)
