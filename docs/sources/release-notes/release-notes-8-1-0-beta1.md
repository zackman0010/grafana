...
## \_build: list: false labels: products: - cloud - enterprise - oss title: Release notes for Grafana 8.1.0-beta1
...
- **Loki:** Add support for "label\_values(log stream selector, label)" in templating. [\#35488](https://github.com/grafana/grafana/pull/35488), [@ivanahuckova](https://github.com/ivanahuckova)
...
- **live:** Add support to handle origin without a value for the port when matching with root\_url. [\#36834](https://github.com/grafana/grafana/pull/36834), [@FZambia](https://github.com/FZambia)
