...
## \_build: list: false labels: products: - cloud - enterprise - oss title: Release notes for Grafana 8.3.0-beta2
...
- **Query caching:** Increase max\_value\_mb default to 10. (Enterprise)
