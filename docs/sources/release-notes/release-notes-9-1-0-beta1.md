...
## aliases: \[\] hide\_menu: true labels: products: - cloud - enterprise - oss title: Release notes for Grafana 9.1.0-beta1
...
- **Alerting:** Add config disabled\_labels to disable reserved labels. [\#51832](https://github.com/grafana/grafana/pull/51832), [@JacobsonMT](https://github.com/JacobsonMT)
...
- **Alerting:** Add first Grafana reserved label grafana\_folder. [\#50262](https://github.com/grafana/grafana/pull/50262), [@JacobsonMT](https://github.com/JacobsonMT)
...
- **Alerting:** Update default route groupBy to \[grafana\_folder, alertname\]. [\#50052](https://github.com/grafana/grafana/pull/50052), [@JacobsonMT](https://github.com/JacobsonMT)
...
- **Reports:** Add created column in report\_dashboards. (Enterprise)
...
- **Elasticsearch:** Always use fixed\_interval. [\#50297](https://github.com/grafana/grafana/pull/50297), [@gabor](https://github.com/gabor)
...
- grafana\_datasource\_request\_total
- grafana\_datasource\_request\_duration\_seconds
- grafana\_datasource\_response\_size\_bytes
- grafana\_datasource\_request\_in\_flight
- grafana\_plugin\_request\_duration\_milliseconds
- grafana\_alerting\_rule\_evaluation\_duration\_seconds Issue [\#50420](https://github.com/grafana/grafana/issues/50420)
...
| Label          | Description                               |
| -------------- | ----------------------------------------- | --------------------------------------------------------------- |
| grafana\_folder | Title of the folder containing the alert. | Issue [\#50262](https://github.com/grafana/grafana/issues/50262) |
