...
## hide\_menu: true labels: products: - cloud - enterprise - oss title: Release notes for Grafana 8.4.0-beta1
...
- **Auth:** implement auto\_sign\_up for auth.jwt. [\#37040](https://github.com/grafana/grafana/pull/37040), [@Roguelazer](https://github.com/Roguelazer)
