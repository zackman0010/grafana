...
## \_build: list: false labels: products: - cloud - enterprise - oss title: Release notes for Grafana 8.3.4
...
- **Prometheus:** Fix interpolation of $\_\_rate\_interval variable. [\#44035](https://github.com/grafana/grafana/pull/44035), [@ivanahuckova](https://github.com/ivanahuckova)
