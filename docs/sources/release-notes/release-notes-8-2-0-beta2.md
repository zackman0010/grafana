...
## \_build: list: false labels: products: - cloud - enterprise - oss title: Release notes for Grafana 8.2.0-beta2
...
- **InfluxDB:** Added support for $\_\_interval and $\_\_interval\_ms in Flux queries for alerting. [\#38889](https://github.com/grafana/grafana/pull/38889), [@gabor](https://github.com/gabor)
