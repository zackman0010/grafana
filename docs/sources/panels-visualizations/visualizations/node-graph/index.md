...
This visualization needs a specific shape of the data to be returned from the data source in order to correctly display it. Field names, however, can be overridden in the visualization settings.
