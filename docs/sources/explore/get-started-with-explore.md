...
2. Select a data source from the drop-down in the upper left.

3. Using the query editor provided for the specific data source, begin writing your query. Each query editor differs based on each data source's unique elements.
...
2. Run and re-run queries as often as needed.
...
2. Select one of the options under **Time-Sync URL Links**.
