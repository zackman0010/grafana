...
Other dependency injection tools for Go like [dig](https://github.com/uber-go/dig) or [facebookgo/inject](https://github.com/facebookgo/inject)
...
Wire's approach was inspired by [Dagger 2](https://google.github.io/dagger/). However, it is not the aim of Wire
...
written for Wire. Tools like [`gorename`](https://godoc.org/golang.org/x/tools/cmd/gorename) or [guru](https://golang.org/s/using-guru) would not be able to
...
subtract command](https://github.com/google/wire/issues/8) would automate the toil in this process.
