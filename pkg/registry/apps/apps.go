...
import (
	...
	"github.com/grafana/grafana/pkg/registry/apps/iam"
...
func ProvideRegistryServiceSink(
	...
	iamAppProvider *iam.IAMAppProvider,
) (*Service, error) {
	...
	runner, err := runner.NewAPIGroupRunner(cfg, playlistAppProvider, iamAppProvider)
	if err != nil {
		return nil, err
	}
