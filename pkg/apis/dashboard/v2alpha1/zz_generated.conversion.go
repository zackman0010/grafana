...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*ConversionIssues)(nil), (*dashboard.ConversionIssues)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v2alpha1_ConversionIssues_To_dashboard_ConversionIssues(a.(*ConversionIssues), b.(*dashboard.ConversionIssues), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*dashboard.ConversionIssues)(nil), (*ConversionIssues)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_dashboard_ConversionIssues_To_v2alpha1_ConversionIssues(a.(*dashboard.ConversionIssues), b.(*ConversionIssues), scope)
	}); err != nil {
		return err
	}
	...
	if err := s.AddGeneratedConversionFunc((*DashboardStatus)(nil), (*dashboard.DashboardStatus)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v2alpha1_DashboardStatus_To_dashboard_DashboardStatus(a.(*DashboardStatus), b.(*dashboard.DashboardStatus), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*dashboard.DashboardStatus)(nil), (*DashboardStatus)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_dashboard_DashboardStatus_To_v2alpha1_DashboardStatus(a.(*dashboard.DashboardStatus), b.(*DashboardStatus), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v2alpha1_ConversionIssues_To_dashboard_ConversionIssues(in *ConversionIssues, out *dashboard.ConversionIssues, s conversion.Scope) error {
...
// Convert_v2alpha1_ConversionIssues_To_dashboard_ConversionIssues is an autogenerated conversion function.
func Convert_v2alpha1_ConversionIssues_To_dashboard_ConversionIssues(in *ConversionIssues, out *dashboard.ConversionIssues, s conversion.Scope) error {
	return autoConvert_v2alpha1_ConversionIssues_To_dashboard_ConversionIssues(in, out, s)
}

func autoConvert_dashboard_ConversionIssues_To_v2alpha1_ConversionIssues(in *dashboard.ConversionIssues, out *ConversionIssues, s conversion.Scope) error {
	out.SourceVersion = in.SourceVersion
	out.Errors = *(*[]string)(unsafe.Pointer(&in.Errors))
	out.Warnings = *(*[]string)(unsafe.Pointer(&in.Warnings))
	return nil
...
// Convert_dashboard_ConversionIssues_To_v2alpha1_ConversionIssues is an autogenerated conversion function.
func Convert_dashboard_ConversionIssues_To_v2alpha1_ConversionIssues(in *dashboard.ConversionIssues, out *ConversionIssues, s conversion.Scope) error {
	return autoConvert_dashboard_ConversionIssues_To_v2alpha1_ConversionIssues(in, out, s)
}
...
func autoConvert_v2alpha1_DashboardStatus_To_dashboard_DashboardStatus(in *DashboardStatus, out *dashboard.DashboardStatus, s conversion.Scope) error {
	if err := Convert_v2alpha1_ConversionIssues_To_dashboard_ConversionIssues(&in.ConversionIssues, &out.ConversionIssues, s); err != nil {
		return err
	}
	return nil
}

// Convert_v2alpha1_DashboardStatus_To_dashboard_DashboardStatus is an autogenerated conversion function.
func Convert_v2alpha1_DashboardStatus_To_dashboard_DashboardStatus(in *DashboardStatus, out *dashboard.DashboardStatus, s conversion.Scope) error {
	return autoConvert_v2alpha1_DashboardStatus_To_dashboard_DashboardStatus(in, out, s)
}

func autoConvert_dashboard_DashboardStatus_To_v2alpha1_DashboardStatus(in *dashboard.DashboardStatus, out *DashboardStatus, s conversion.Scope) error {
	if err := Convert_dashboard_ConversionIssues_To_v2alpha1_ConversionIssues(&in.ConversionIssues, &out.ConversionIssues, s); err != nil {
		return err
	}
	return nil
}

// Convert_dashboard_DashboardStatus_To_v2alpha1_DashboardStatus is an autogenerated conversion function.
func Convert_dashboard_DashboardStatus_To_v2alpha1_DashboardStatus(in *dashboard.DashboardStatus, out *DashboardStatus, s conversion.Scope) error {
	return autoConvert_dashboard_DashboardStatus_To_v2alpha1_DashboardStatus(in, out, s)
}
