...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		...
		"github.com/grafana/grafana/pkg/apis/dashboard/v1alpha1.ConversionIssues":        schema_pkg_apis_dashboard_v1alpha1_ConversionIssues(ref),
...
func schema_pkg_apis_dashboard_v1alpha1_ConversionIssues(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
				Properties: map[string]spec.Schema{
					"sourceVersion": {
						SchemaProps: spec.SchemaProps{
							Description: "The original apiVersion",
							Type:        []string{"string"},
							Format:      "",
						},
					},
...
func schema_pkg_apis_dashboard_v1alpha1_Dashboard(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							Description: "The dashboard body (dashboard json, migrated to schemaVersion LATEST_VERSION if possible)",
							Default:     map[string]interface{}{},
					...
					"status": {
						SchemaProps: spec.SchemaProps{
							Description: "Optional status when conversion issues exist",
		...
		Dependencies: []string{
			"github.com/grafana/grafana/pkg/apis/dashboard/v1alpha1.DashboardSpec", "github.com/grafana/grafana/pkg/apis/dashboard/v1alpha1.DashboardStatus", "k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta"},
	}
}
...
func schema_pkg_apis_dashboard_v1alpha1_DashboardStatus(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					"conversionIssues": {
						SchemaProps: spec.SchemaProps{
							Description: "When conversion issues exist, clients may need to manually convert the spec",
							Default:     map[string]interface{}{},
							Ref:         ref("github.com/grafana/grafana/pkg/apis/dashboard/v1alpha1.ConversionIssues"),
						},
					},
				},
			},
		...
		Dependencies: []string{
			"github.com/grafana/grafana/pkg/apis/dashboard/v1alpha1.ConversionIssues"},
	}
}
...
func schema_pkg_apis_dashboard_v1alpha1_DashboardWithAccessInfo(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		...
		Dependencies: []string{
			"github.com/grafana/grafana/pkg/apis/dashboard/v1alpha1.DashboardAccess", "github.com/grafana/grafana/pkg/apis/dashboard/v1alpha1.DashboardSpec", "github.com/grafana/grafana/pkg/apis/dashboard/v1alpha1.DashboardStatus", "k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta"},
	}
}
