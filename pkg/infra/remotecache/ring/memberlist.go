...
type memberlistConfig struct {
	// Addr is the address to bind to. GRPC server should be listening on this address.
	Addr string
	// Port is the port to bind to.
	Port int
	// AdvertiseAddr is the address to advertise to other members. Must be reachable by other members.
	AdvertiseAddr string
	// AdvertisePort is the port to advertise to other members.
	AdvertisePort int
	// List of members Advertising addresses:ports to join.
	JoinMembers []string
}
