...
require (
	...
	github.com/grafana/grafana-plugin-sdk-go v0.256.0 // @grafana/plugins-platform-backend
	...
	github.com/prometheus/common v0.60.0 // @grafana/alerting-backend
...
require github.com/elimity-com/scim v0.0.0-20240320110924-172bf2aee9c8
