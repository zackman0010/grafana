...
require (
	...
	github.com/grafana/authlib v0.0.0-20250314103336-fdf713e40b6a // @grafana/identity-access-team
	github.com/grafana/authlib/types v0.0.0-20250314102521-a77865c746c0 // @grafana/identity-access-team
