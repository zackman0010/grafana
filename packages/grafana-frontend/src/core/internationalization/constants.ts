...
export const LANGUAGES: LanguageDefinition[] = [
  {
    ...
    name: 'English',
    loader: {
      grafana: () => import('../../../../../public/locales/en-US/grafana.json'),
    },
  },

  {
    ...
    name: 'Français',
    loader: {
      grafana: () => import('../../../../../public/locales/fr-FR/grafana.json'),
    },
  },

  {
    ...
    name: 'Español',
    loader: {
      grafana: () => import('../../../../../public/locales/es-ES/grafana.json'),
    },
  },

  {
    ...
    name: 'Deutsch',
    loader: {
      grafana: () => import('../../../../../public/locales/de-DE/grafana.json'),
    },
  },

  {
    ...
    name: '中文（简体）',
    loader: {
      grafana: () => import('../../../../../public/locales/zh-Hans/grafana.json'),
    },
  },

  {
    ...
    loader: {
      grafana: () => import('../../../../../public/locales/pt-BR/grafana.json'),
    },
  },

  {
    ...
    name: '中文（繁體）',
    loader: {
      grafana: () => import('../../../../../public/locales/zh-Hant/grafana.json'),
    },
  },

  {
    ...
    name: 'Italiano',
    loader: {
      grafana: () => import('../../../../../public/locales/it-IT/grafana.json'),
    },
  },

  {
    ...
    name: '日本語',
    loader: {
      grafana: () => import('../../../../../public/locales/ja-JP/grafana.json'),
    },
  },

  {
    ...
    loader: {
      grafana: () => import('../../../../../public/locales/id-ID/grafana.json'),
    },
  },

  {
    ...
    name: '한국어',
    loader: {
      grafana: () => import('../../../../../public/locales/ko-KR/grafana.json'),
    },
  },

  {
    ...
    name: 'Русский',
    loader: {
      grafana: () => import('../../../../../public/locales/ru-RU/grafana.json'),
    },
  },

  {
    ...
    name: 'Čeština',
    loader: {
      grafana: () => import('../../../../../public/locales/cs-CZ/grafana.json'),
    },
  },

  {
    ...
    name: 'Nederlands',
    loader: {
      grafana: () => import('../../../../../public/locales/nl-NL/grafana.json'),
    },
  },

  {
    ...
    name: 'Magyar',
    loader: {
      grafana: () => import('../../../../../public/locales/hu-HU/grafana.json'),
    },
  },

  {
    ...
    name: 'Português',
    loader: {
      grafana: () => import('../../../../../public/locales/pt-PT/grafana.json'),
    },
  },

  {
    ...
    name: 'Polski',
    loader: {
      grafana: () => import('../../../../../public/locales/pl-PL/grafana.json'),
    },
  },

  {
    ...
    name: 'Svenska',
    loader: {
      grafana: () => import('../../../../../public/locales/sv-SE/grafana.json'),
    },
  },

  {
    ...
    name: 'Türkçe',
    loader: {
      grafana: () => import('../../../../../public/locales/tr-TR/grafana.json'),
    },
  },
